...
Fixpoint eval_const (env : const_env) (t : p_expr) : option pl_val :=
  ...
  | PListIsNil e =>
      match eval_const env e with
      | Some (PLitList []) => Some (PLitBool true)
...
Fixpoint replace_const_calls (env : const_env) (t : p_expr) : p_expr :=
  ...
  | PListIsNil e => PListIsNil (replace_const_calls env e)
  | PListCons e1 e2 => PListCons (replace_const_calls env e1) (replace_const_calls env e2)
  end.
