...
(* line 7: [precondition] (a >= 0) *)
(* line 7: [precondition] (b >= 0) *)
(* line 11: [general] (asZ (s "a"%string) = asZ (s "old_a"%string)) *)
(* line 11: [general] (asZ (s "b"%string) = asZ (s "old_b"%string)) *)
(* line 13: [postcondition] (asZ (s "result"%string) = ((asZ (s "a"%string) + asZ (s "b"%string)) + 2)) *)
